...
const MainTitle = memo(({ cloud, engineer }) => (
...
const SOCIAL_LINKS = [
  ...
  { icon: Mail, link: "mailto:djossou628@gmail.com" }
];

const Home = () => {
  const { t } = useTranslation('home');
  const WORDS = [t('typing.word1'), t('typing.word2')];
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                <StatusBadge text={t('status.ready')} />
                <MainTitle cloud={t('title.cloud')} engineer={t('title.engineer')} />
                ...
                <div className="flex flex-row gap-3 w-full justify-start" data-aos="fade-up" data-aos-delay="1400">
                  <CTAButton href="#Portofolio" text={t('buttons.projects')} icon={ExternalLink} />
                  <CTAButton href="#Contact" text={t('buttons.contact')} icon={Mail} />
                </div>
